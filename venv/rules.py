...
# Define rules
rules = [
    'Symptom(Me, YellowOrangeBrownPustules) & Symptom(Me, Defoliation) ==> RecommendDisease(Rust, Me)',
    'Symptom(Me, Defoliation) & Symptom(Me, CircularIrregularlySpots) ==> RecommendDisease(LeafSpotDiseases, Me)',
    'Symptom(Me, GrayBrownFuzz) & (Symptom(Me, WaterSoakedSpots) & Symptom(Me, MustyOdor)) ==> RecommendDisease(GrayMold, Me)',
    'Symptom(Me, StuntedFuzzyGrowth) & Symptom(Me, YellowBrownSpots) & (Symptom(Me, Wilting) & (Symptom(Me, DarkMushyDecayedRoots))) ==> RecommendDisease(RootRot, Me)',
    'Symptom(Me, YellowSpots) & Symptom(Me, VerticilliumWilt) ==> RecommendDisease(VerticilliumWilt, Me)',
    'Symptom(Me, YellowSpots) & Symptom(Me, FusariumWilt) ==> RecommendDisease(FusariumWilt, Me)',
    'Symptom(Me, YellowSpots) & Symptom(Me, DownyMildew) ==> RecommendDisease(DownyMildew, Me)',
    'Symptom(Me, YellowSpots) & Symptom(Me, PowderyMildew) ==> RecommendDisease(PowderyMildew, Me)',
    'Symptom(Me, MustyOdor) ==> RecommendDisease(GrayMold, Me)',
    'Symptom(Me, DarkMushyDecayedRoots) ==> RecommendDisease(RootRot, Me)',
    'Symptom(Me, CircularSpots) ==> RecommendDisease(LeafSpotDiseases, Me)',
    'Symptom(Me, WaterSoakedSpots) ==> RecommendDisease(GrayMold, Me)',
    'Symptom(Me, DarkColoredSap) ==> RecommendDisease(LateBlight, Me)',
    'Symptom(Me, BrownBlackSpots) ==> RecommendDisease(Anthracnose, Me)',
    'Symptom(Me, GreyPurpleFuzz) ==> RecommendDisease(GrayMold, Me)',
    'Symptom(Me, FuzzyWhiteMold) ==> RecommendDisease(PowderyMildew, Me)',
    'Symptom(Me, CurlyLeaves) ==> RecommendDisease(DownyMildew, Me)',
    'Symptom(Me, OnlyOneSideIsAffected) ==> RecommendDisease(VerticilliumWilt, Me)',
    'Symptom(Me, AllThePlantIsAffected) ==> RecommendDisease(VerticilliumWilt, Me)',
    'Symptom(Me, BrownStricksOnViscularTissue) & Symptom(Me, RootRot) ==> RecommendDisease(RootRot, Me)',
    'Symptom(Me, BrownStricksOnViscularTissue) & Symptom(Me, VerticilliumWilt) ==> RecommendDisease(VerticilliumWilt, Me)',
    'Symptom(Me, BrownStricksOnViscularTissue) & Symptom(Me, FusariumWilt) ==> RecommendDisease(FusariumWilt, Me)',
    'Symptom(Me, BrownStricksOnViscularTissue) & Symptom(Me, LateBlight) ==> RecommendDisease(LateBlight, Me)',
    'Symptom(Me, PinkishSporeMasses) ==> RecommendDisease(DownyMildew, Me)'
]
